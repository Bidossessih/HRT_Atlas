...
fluidRow(useShinyjs(),
  ...
  includeHTML("External/HTML/visualization.html"),

    
  div(class="Container-fluid panelstyle",   
             #includeHTML("External/HTML/searchHsGenes.html"),
             
             selectInput('searchHSGenes', 'Select a human housekeeping gene to show its transcript expression in different tissues/cells', sort(HK_geneAtualizadoRef$choice), selectize=FALSE),
